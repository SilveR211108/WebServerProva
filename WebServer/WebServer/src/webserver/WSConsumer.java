...
public class WSConsumer {
    ...
    private String prefix = "http://circolarizotizione.altervista.org/";
    ...
    public int aggUtente(String username, String password, String email, String nome, String cognome, String classe) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        int status = 0;
        result = "";
        ...
        try {
            ...
            String url = prefix+"aggiungiUtente/"
                    + "aggUtente.php?"
            ...
            service = (HttpURLConnection) serverURL.openConnection();
            // impostazione header richiesta . ftp.gestioneagenda.altervista.org
            service.setRequestProperty("Host", "circolarizotizione.altervista.org");
            service.setRequestProperty("Accept", "application/text");
            service.setRequestProperty("Accept-Charset", "UTF-8");
            // impostazione metodo di richiesta GET
            service.setRequestMethod("GET");
	...
	public int inserisciCircolare(String titolo, String descrizione, String data) {
        int status = 0;
        result = "";
    ...
    public int addImpegno(String nome, String descrizione, String voce) {
        int status = 0;
        result = "";
        ...
        try {
            ...
            String url = prefix+"gestioneImpegni/"
                    ...
                    + "nome=" + URLEncoder.encode(nome, "UTF-8")
                    + "&descrizione=" + URLEncoder.encode(descrizione, "UTF-8")
                    + "&voce=" +URLEncoder.encode(voce, "UTF-8") ;
            serverURL = new URL(url);
            System.out.println(url);
            service = (HttpURLConnection) serverURL.openConnection();
